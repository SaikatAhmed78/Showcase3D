...
export const workExperiences = [
  {
    ...
    duration: "2023 - 2025",
    title:
      "Webflow serves as my go-to tool for creating interactive prototypes. I use it to bring designs to  life, allowing stakeholders to experience the user flow and interactions before development.",
